...
int main(int argc, char *argv[]) {
    ...
    std::string coreBandwidth = "100Mbps";
...
Ptr<Ipv4StaticRouting> pgwRouting = ipv4RoutingHelper.GetStaticRouting(pgw->GetObject<Ipv4>());
    ...
    Config::SetDefault("ns3::TcpL4Protocol::SocketType", TypeIdValue(TcpBbr::GetTypeId())); // Using BBR
    Config::SetDefault("ns3::NrMacSchedulerTdmaRR::HarqEnabled", BooleanValue(true));
    ...
    // 1.UDP ONOFFHELPER  
        ...
        onOffHelper1.SetAttribute("OnTime", StringValue("ns3::ConstantRandomVariable[Constant=5]"));
        onOffHelper1.SetAttribute("OffTime", StringValue("ns3::ConstantRandomVariable[Constant=5]"));
        onOffHelper1.SetAttribute ("DataRate",StringValue ("50Mbps"));
